...
const testimonials = [
    {
        ...
        content:
            'Resume Builder is a web application that enables users to craft and personalize professional resumes quickly and easily. It offers a variety of templates and customization options to match individual career goals and styles.',
        avatar:
            '/img.png',
    }
];
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="author" content="Divya Padisetti" />
            ...
            <Flex
                ...
                <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
                    ...
                    <chakra.h2
                        ...
                        Create Your Resume, Land Your Dream Job!
                    </chakra.h2>
                </Box>
                <SimpleGrid
                    columns={{ base: 1, xl: 1 }}
